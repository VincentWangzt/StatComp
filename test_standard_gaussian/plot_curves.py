...
def latest_run(results_root: Path, runner: str) -> Path:
    target_root = results_root / runner / TARGET
...
def main() -> None:
    ...
    parser.add_argument("--results-root", default="results/test_standard_gaussian")
    parser.add_argument("--output-dir", default="test_standard_gaussian")
