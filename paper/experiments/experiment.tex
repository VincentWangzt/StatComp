...
All reverse-model methods (SIVI, UIVI, AISIVI, DSIVI) are trained for 10,000 VI iterations with learning rate $10^{-3}$, batch size 128, step scheduler (decay 0.7 every 1,000 steps), and 5,000-step linear annealing.  KSIVI is trained for 100,000 iterations.
